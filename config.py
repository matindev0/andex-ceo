...
GUILD_ID             = 123456789012345678          # Your server’s Guild ID (int)
OWNER_ID             = 987654321098765432          # Server owner’s Discord user ID (int)
...
# These are default names; actual IDs are stored in the DB after /setup.
...
# How often (in seconds) Aria may spontaneously post in ideas channel
